...
public class BattleShipStackPane extends StackPane {
    Graphic.Title title = new Graphic.Title("B A T T L E S H I P");
    {
        title.setTranslateX(-20);
        title.setTranslateY(-200);
    }
    private Graphic.MenuItem newGame = new Graphic.MenuItem("NEW GAME", 400, 50);
    Graphic.MenuItem statistics = new Graphic.MenuItem("STATISTICS", 400, 50);
    private Graphic.MenuItem exitGame = new Graphic.MenuItem("EXIT", 400, 50);
    ...
    private Graphic.SubMenu newGameMenu = new Graphic.SubMenu(
